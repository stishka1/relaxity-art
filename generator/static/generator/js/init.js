...
StringArtGenerator.prototype.InitSelectButton = function() {
    ...
    this.selectBtn = document.getElementById('elem')
...
StringArtGenerator.prototype.InitControls = function() {
    ...
    this.formblock = document.getElementById('form-block')
    this.formblock.addEventListener('change', () => this.UpdateForm())

    this.formTypeBox = document.getElementById('form-type-box')
    this.formTypeBox.addEventListener('change', () => this.UpdateForm())

    this.gvozdiplacebox = document.getElementById('gvozdi-place-box')
    this.gvozdiplacebox.addEventListener('change', () => this.UpdateForm())

    this.gvozdiquantity = document.getElementById('gvozdi-quantity')
    this.gvozdiquantity.addEventListener('change', () => this.UpdateForm())
    
    this.stringsquantity = document.getElementById('strings-quantity')
    this.stringsquantity.addEventListener('change', () => this.UpdateForm())
    ...
    this.liveToastBtn = document.getElementById('liveToastBtn')
...
StringArtGenerator.prototype.InitSave = function() {
    ...
    this.saveTypeBox1 = document.getElementById('save-type-box1')
    this.saveTypeBox2 = document.getElementById('save-type-box2')
